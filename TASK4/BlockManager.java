...
public class BlockManager
{
	...
	static class AcquireBlock extends BaseThread
	{
		...
		public void run()
		{
			...
			phase1();
			s1.Signal();
			System.out.println("Thread" + this.iTID + " has s1 incremented to " + s1.getiValue());
			s1.Wait();
			System.out.println("Thread" + this.iTID + " has s1 decremented to " + s1.getiValue());
			s1.Signal();			
			System.out.println("Thread" + this.iTID + " has s1 incremented to " + s1.getiValue());
			System.out.println("Thread" + this.iTID +" About to enter try-block");
