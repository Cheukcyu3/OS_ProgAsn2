package OS_PROGASN2.TASK5;
// Import (aka include) some stuff.
// import common.*;
import java.io.*;

import OS_PROGASN2.TASK5.BlockManager.AcquireBlock;
import OS_PROGASN2.TASK5.BlockManager.CharStackProber;
import OS_PROGASN2.TASK5.BlockManager.ReleaseBlock;
...
public class BlockManager
{
	...
	public static void main(String[] argv)
	{
		...
		try
		{
			...
			System.out.println("All threads finished Phase II!!!!!!!!!!!");
	...
	static class AcquireBlock extends BaseThread
	{
		...
		public void run()
		{
			...
			while(!turnTestAndSet(true)){
				System.out.println("thread [TID="+this.iTID+"] is waiting to enter PHASE II");
			}
			s2.Wait();
			phase2();
			s2.Signal();
